import pytest
from Mio.Municipio import Municipio  # Asegurate de que la clase Municipio este correctamente importada
...
def test_inicializacion(municipio):
    assert municipio.darNombre() == "", "El nombre inicial debe ser una cadena vacia"
    assert municipio.darPoblacion() == 0, "La poblacion inicial debe ser 0"
...
def test_asignar_poblacion(municipio):
    ...
    assert municipio.darPoblacion() == 1000, "La poblacion asignada es incorrecta"
